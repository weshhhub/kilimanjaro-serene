...
import { X, Clock, CheckCircle2, ArrowRight, Sparkles } from 'lucide-react';
...
export default function ExperienceDetailsModal({ experience, activeStay, bookingData, onClose, onBook }: ExperienceDetailsModalProps) {
        ...
        >
          ...
          <div className="md:w-1/2 overflow-y-auto p-8 md:p-12">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-accent uppercase tracking-[0.2em] text-[10px] font-bold block">
                {experience.category}
              </span>
            </div>
            <h2 className="text-4xl font-display text-primary mb-6">{experience.title}</h2>
            ...
            <div className="flex flex-wrap gap-6 mb-8">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-sm font-medium text-secondary">{experience.duration}</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-primary/10 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>
                ...
                <span className="text-3xl font-display text-primary">${experience.price}</span>
              </div>
              <Button variant="primary" className="px-8" icon={ArrowRight} onClick={() => onBook(experience)}>
                {getButtonText()}
              </Button>
            </div>
          </div>
